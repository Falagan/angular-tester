(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@fortawesome/angular-fontawesome'), require('@angular/router'), require('@fortawesome/fontawesome-svg-core'), require('@fortawesome/free-solid-svg-icons'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define('ui', ['exports', '@angular/core', '@angular/common', '@fortawesome/angular-fontawesome', '@angular/router', '@fortawesome/fontawesome-svg-core', '@fortawesome/free-solid-svg-icons', '@angular/forms'], factory) :
    (global = global || self, factory(global.ui = {}, global.ng.core, global.ng.common, global.angularFontawesome, global.ng.router, global.fontawesomeSvgCore, global.freeSolidSvgIcons, global.ng.forms));
}(this, function (exports, core, common, angularFontawesome, router, fontawesomeSvgCore, freeSolidSvgIcons, forms) { 'use strict';
    ...
    var HomeLoginComponent = /** @class */ (function () {
        ...
        function () {
            this.loginForm = this._formBuilder.group({
                user: ['', [forms.Validators.required, forms.Validators.minLength(5)]],
    ...
    exports.BootstrapCustomModule = BootstrapCustomModule;
    exports.ɵa = AsideMenuComponent;
    exports.ɵb = HomeLoginComponent;
